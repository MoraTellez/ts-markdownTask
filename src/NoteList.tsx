...
export default function NoteList({ availableTags, notes, onUpdateTag, onDeleteTag }: NoteListProps) {
  ...
  return (
    <>
      ...
      <EditTagsModal onUpdateTag={onUpdateTag} onDeleteTag={onDeleteTag} show={editTagsModalOpen}  handleClose={() => setEditTagsModalOpen(false)} availableTags={availableTags}/>
    </>
  )
}
